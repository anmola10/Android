...
public class Disp2Activity extends Activity
{
  String add;
  String beg;
  String course;
    ...
    for (int i = 0; ; i++)
    {
      if (i >= 10)
      {
        ...
        View.OnClickListener local1 = new View.OnClickListener()
        {
          ...
          {
            Toast.makeText(Disp2Activity.this, "Saved", 1).show();
            PrintManager localPrintManager = (PrintManager)Disp2Activity.this.getSystemService("print");
            PrintDocumentAdapter localPrintDocumentAdapter = Disp2Activity.this.web.createPrintDocumentAdapter();
            localPrintManager.print(Disp2Activity.this.getString(2131099648) + " Print Test", localPrintDocumentAdapter, new PrintAttributes.Builder().build());
          }
        };
        ...
        View.OnClickListener local2 = new View.OnClickListener()
        {
          public void onClick(View paramAnonymousView)
          {
            Intent localIntent = new Intent(Disp2Activity.this, HomeActivity.class);
            Disp2Activity.this.startActivity(localIntent);
          }
        };
      ...
      String str = "<html><head><h1><align=left>" + this.name + "</align></h1></head><body><b><p/>" + this.add + " <br/>" + this.phone + "<br/>" + this.mail + "</b></center><hr/><p/><h3><align=" + "left" + ">Work Experience</align></h3><hr/><p/><h4>" + this.desig + "<br/>" + this.org + "<br/>" + this.beg + "-" + this.till + "</center></h4></ul><p/><h3><hr/><align=" + "left" + ">Education<hr/></align></h3><p/><center>" + this.school + "<br/>" + this.course + "<br/>" + this.from + "-" + this.to + "<p/>s</center><h3><hr/>Skills<center><hr/></h3><p/>" + this.s1 + "<br/>" + this.s2 + "<br/>" + this.s3 + "<br/>" + this.s4 + "<br/></center><hr/>" + "<h3>References</h3><hr/><p/>" + this.r1 + "<br/>" + this.r2 + "<br/>" + this.r3 + "<br/>" + this.r4 + "</body></html>";
 ...
 * Qualified Name:     com.anmolinc.linker.Disp2Activity
