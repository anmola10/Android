...
public abstract class UPCEANReader extends OneDReader
{
  ...
  private static boolean checkStandardUPCEANChecksum(CharSequence paramCharSequence)
  ...
  static int[] findGuardPattern(BitArray paramBitArray, int paramInt, boolean paramBoolean, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
    throws NotFoundException
  {
    ...
    throws NotFoundException, ChecksumException, FormatException
  {
    ...
    try
    {
      ...
      label335: if ((localBarcodeFormat == BarcodeFormat.EAN_13) || (localBarcodeFormat == BarcodeFormat.UPC_A))
      {
