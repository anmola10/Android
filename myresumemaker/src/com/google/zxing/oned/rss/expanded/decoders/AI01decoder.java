...
abstract class AI01decoder extends AbstractExpandedDecoder
{
  ...
  protected void encodeCompressedGtin(StringBuilder paramStringBuilder, int paramInt)
  {
  ...
  protected void encodeCompressedGtinWithoutAI(StringBuilder paramStringBuilder, int paramInt1, int paramInt2)
  {
    for (int i = 0; i < 4; i++)
    {
